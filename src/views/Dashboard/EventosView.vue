                        ...
                        <form action="" method="POST" enctype="">
                            <div class="row my-5 ">
                                <div class="form-group col-10 col-sm-8 offset-sm-2 col-lg-8 offset-lg-2">
                                    <h4 class="card-title mt-1" id="nombre" name="nombre">Nombre del Evento</h4>
                                </div>
                                <div class="form-group col-10 col-sm-8 offset-sm-2 col-lg-8 offset-lg-2">
                                ...
                                <div class="form-group my-3 col-10 col-sm-8 offset-sm-2 col-lg-8 offset-lg-2">
                                    <h4 class="card-title mt-1" id="imagen">Imagen del Evento</h4>
                                </div>
                                <div class="form-group col-10 col-sm-8 offset-sm-2 col-lg-8 offset-lg-2">
                                ...
                                <div class="form-group my-3 col-10 col-sm-8 offset-sm-2 col-lg-8 offset-lg-2">
                                    <h4 class="card-title mt-1" id="direccion">Direccion del Evento</h4>
                                </div>
                                <div class="form-group col-10 col-sm-8 offset-sm-2 col-lg-8 offset-lg-2">
